...
Service Vendors who deploy Polaris may also leverage certain operational metrics for monitoring purposes (e.g. storage cost monitoring). Typically, total storage would be a straightforward candidate for such a use case.
